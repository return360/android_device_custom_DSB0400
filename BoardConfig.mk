...
# this uses s9863a1h10_go_32b's BoardConfig as base
include device/sprd/sharkl3/s9863a1h10_go_32b/BoardConfig.mk
...
# EQ. to "getconf PAGE_SIZE"
BOARD_FLASH_BLOCK_SIZE := 4096
BOARD_CACHEIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_PRODNVIMAGE_FILE_SYSTEM_TYPE := ext4

BOARD_SUPER_PARTITION_SIZE := 3093299200
BOARD_GROUP_UNISOC_SIZE := 3093299200
...
# TODO: figure out from original sensor_config.xml (hopefully)
# ANSWER: [vendor.cam.sensor.info]
#id0 s5k3l6xx03 13M --> "CAMERA" (back)
#id1 gc5035 5M --> FRONT
#id2 gc02m1b_js_1 2M --> BACK_EXT
#id3 gc02m1_m 2M --> BACK_EXT2
...
# TODO: gotta adjust it to target device
#camera sensor support list
#example
#CAMERA_SENSOR_TYPE_BACK :="ov8856,ov8858"
CAMERA_SENSOR_TYPE_BACK := "s5k3l6xx03"
CAMERA_SENSOR_TYPE_FRONT := "gc5035"
CAMERA_SENSOR_TYPE_BACK_EXT := "gc02m1b_js_1"
CAMERA_SENSOR_TYPE_BACK_EXT2 := "gc02m1_m"
...
TUNING_PARAM_LIST := "s5k3l6xx03_back_main,gc5035,gc02m1b_js_1_param,gc02m1_m_param"
...
#flash IC
# this matches in target device binaries (grep), so going with this.
TARGET_BOARD_CAMERA_FLASH_TYPE := ocp8137
# for target device (maybe the  previous one is the correct one)
#TARGET_BOARD_CAMERA_FLASH_TYPE := sgm37891
#TARGET_BOARD_CAMERA_FLASH_TYPE := flash_ic_sgm37891
...
# COMMENT: target device also uses this.
#GNSS GPS
...
# POSSIBLE MODIFICATION: Set to true? (FM Radio)
# select FMRadio
...
# WIFI configs
# COMMENT: probably target device one, since search in target device binaries "matches"
BOARD_WPA_SUPPLICANT_DRIVER := NL80211
WPA_SUPPLICANT_VERSION      := VER_2_1_DEVEL
BOARD_WPA_SUPPLICANT_PRIVATE_LIB := lib_driver_cmd_sprdwl
BOARD_HOSTAPD_DRIVER        := NL80211
BOARD_HOSTAPD_PRIVATE_LIB   := lib_driver_cmd_sprdwl
# COMMENT: probably target device one: known there as "sc2332" (.ko module)
...
# COMMENT: alternatively one could try "sc2332_sipc_wlan" (sc2332_sipc_wlan.ko) 
...
USE_SPRD_SENSOR_HUB := true
# TODO: gotta figure out what the sensors are for the target device.
# TODO: could copy-paste below variables in target device BoardConfig and overwrite where necessary
# Config Sensor driver
#SENSOR_HUB_ACCELEROMETER := icm20600
SENSOR_HUB_ACCELEROMETER := accelerometer
SENSOR_HUB_GYROSCOPE := null # not supported
#SENSOR_HUB_LIGHT := ltr553als
SENSOR_HUB_LIGHT := light
#SENSOR_HUB_MAGNETIC := akm09918
SENSOR_HUB_MAGNETIC := magnetic_field
SENSOR_HUB_PROXIMITY := proximity
SENSOR_HUB_PRESSURE := null # barometer, not supported
